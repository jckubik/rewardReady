...
module.exports = (app) => {
  ...
  router.get(
    ...
    walletController.fetchCards
  );
  router.post(
    "/items/cards/insert",
    [
      userMiddleware.verifyToken,
      walletMiddleware.checkCardValidity,
      walletMiddleware.checkCardDuplicates,
    ],
  ...
  router.get(
    "/recommend/card",
    userMiddleware.verifyToken,
    walletController.recommendCard
  );
  router.get(
    "/history",
    userMiddleware.verifyToken,
  ...
  router.post(
    "/history/insert",
    userMiddleware.verifyToken,
    walletController.insertHistory
  );
