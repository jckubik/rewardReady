...
const AddCard = () => {
  ...
  async function fetchCards() {
    ...
    await fetch(
      `https://ccstack.p.rapidapi.com/search/cards?query=${cardCompany}`,
      options
    )
    ...
    <div className="container flex-1">
      <div className="flex-1">
        ...
        >
          ...
          <option key={1} value="american express">
            American Express
          </option>
          <option key={3} value="barclays">
            Barclays
          </option>
          <option key={4} value="capital one">
            Capital One
          </option>
          <option key={5} value="chase">
            Chase
          </option>
          <option key={6} value="citi">
            Citi
          </option>
          <option key={7} value="discover">
            Discover
          </option>
          <option key={8} value="synchrony">
            Synchrony
          </option>
          <option key={9} value="u.s. bank">
            U.S. Bank
          </option>
          <option key={10} value="wells fargo">
            Wells Fargo
          </option>
          <option key={12} value="pnc">
            PNC Bank
          </option>
        </select>
      </div>
        ...
        <div className="flex-1">
          <div className="flex-1">
            ...
            <select
              ...
              id="cardOptions"
              onChange={(event) =>
                setCardToInsert(cardOptions[event.target.value])
              }
            >
